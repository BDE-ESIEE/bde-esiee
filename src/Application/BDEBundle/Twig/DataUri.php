...
use Application\BDEBundle\Twig\DataURI\Dumper;
use Application\BDEBundle\Twig\DataURI\Parser;

/**
 * @Service
 * @Tag("twig.extension")
 *
 * Twig extension for data URI
 * Converts data to the data URI Url scheme
 *
 * @see https://www.ietf.org/rfc/rfc2397.txt
 */
class DataUri extends \Twig_Extension
{
    ...
    {
        return 'application_bde_datauri';
    }
}
